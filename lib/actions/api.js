...
/**
 * Dispatches a method from v1actions or v2actions in the config
...
/**
 * Update the OTP Query parameters in the URL
 */
 ...
 * @return {?number} - null if the URL has already been requested in the last ten seconds
 */
...
/**
 * Reads the host name config to generate a base path to uris
...
/**
 * helper for constructing API queries
 *
